    ...
    <section className="cta">
      <div className="container">
        <div className="text-center cta-head-1">
          <h2 className=" head-cta">
            How do you <span className="green">Buy</span>?
          </h2>
          ...
          <div className="col-md-5">
            <div className=" cta-new-box">
              <div className="cta-details">
                ...
                <h2 className="">
                  Create <span className="green">MetaMask wallet</span>{" "}
                </h2>
                <p className="cta-p">
          ...
          <div className="col-md-5">
            <div className=" cta-new-box">
              <div className="cta-details">
                ...
                <h2 className="">
                  Send <span className="green">ETH</span> to your{" "}
                ...
                <p className="cta-p">
                  ...
                  etc. or you can buy Eth directly on our page without leaving
                  to another platform . Make sure to use the ERC-20 network when
                  transfering ETH.
                </p>
                <p className="cta-p">
            ...
            <div className="col-md-5">
              <div className=" cta-new-box-2">
                <div className="cta-details">
                  ...
                  <h2 className="">
                    Buy with <span className="green">Eth / USDT </span>{" "}
                  </h2>
                  <p className="cta-p">
                    Now that you have topped up your wallet with ETH, you can
                    purchase the Dlance token. First, ensure your wallet is
                    connected , then click BUY and select Eth / USDT , now you
                    are directed to exchange window , Type in the amount of
                    $Dlance you wish to purchase and then click“Convert ETH”.
                    Your wallet provider will ask you to confirm the transaction
                    and will also show you the cost of gas fee .
                    <br />
                    Once you are happy with the transaction details, click
                    ‘Confirm’.
                  </p>
                </div>
              </div>
        ...
        <div className="low-cta">
          <div className=" cta-new-box-3">
            <div className="cta-details">
              <h2 className="">
                How to <span className="green">Claim</span>{" "}
              </h2>

              <p className="cta-p">
                Once the presale has ended, you’ll be able to head over to the
                claim button to claim your purchased Dlance token .{" "}
              </p>
            </div>
          </div>
        </div>
